      ...
      <main id="Home">
        <Container className="jumbotron">
          <h1>For Frodo!</h1>
            ...
            <p>Special thanks to <a href="https://github.com/gitfrosh" rel="noreferrer" target="_blank">Rike</a> and her project <a href="https://the-one-api.dev/" rel="noreferrer" target="_blank">One API to rule them all</a> and <a href="https://thatchmountain.com" rel="noreferrer" target="_blank">Clarissa Leigh</a>, who gave helpful suggestions to improve the user experience.</p>

        </Container>
        <img id="tree" src={LOTRImg} alt="Tree." />
      </main>
    );
  }